...
import static com.example.greenapp.transactions.endec.PolishZlotyDecoder.decodePolishZlotyFieldValueAsBigDecimal;
      ...
      do {
        ...
        switch (buf.readByte()) {
          ...
          case 'a' -> {
            ...
            readToColon(buf);
            transaction.setAmount(decodePolishZlotyFieldValueAsBigDecimal(buf));
            amountRead = true;
          }
